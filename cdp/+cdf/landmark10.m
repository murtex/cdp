function landmark10( run, cfg )
% detect landmarks (version #10)
%
% LANDMARK10( run, cfg )
%
% INPUT
...
% rescaled powers
% epsilon powers
% unrestricted plosion range
% high-pass filtered plosion
% more advanced successive thresholding
	...
	for i = 1:n
		...
		m = 10;
		cutoff = 1500;
		[b, a] = butter( m, cutoff / (run.audiorate/2), 'high' );
		resppiser = filter( b, a, resppiser );
