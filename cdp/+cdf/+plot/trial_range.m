...
% plotfile : plot filename (row char)
	...
	respft = sta.unframe( respft, frame );
		...
		% prepare plot
	xs = sta.smp2msec( (range(1):range(2))-rzp, run.audiorate ); % axes
	xl = [min( xs ), max( xs )];
	...
	stem( sta.smp2msec( trial.cue-rzp, run.audiorate ), yl(2), ... % landmarks
	...
	stem( sta.smp2msec( trial.cue+trial.soa-rzp, run.audiorate ), yl(2), ...
		'Marker', 'o', 'MarkerSize', 2*style.width( +1 ), ...
		'MarkerEdgeColor', style.color( 'cold', -2 ), 'MarkerFaceColor', style.color( 'cold', +1 ), ...
		'Color', style.color( 'cold', 0 ) );
	stem( sta.smp2msec( trial.distvo-rzp, run.audiorate ), yl(2), ...
		'Marker', 'o', 'MarkerSize', 2*style.width( +1 ), ...
		'MarkerEdgeColor', style.color( 'cold', -2 ), 'MarkerFaceColor', style.color( 'cold', +1 ), ...
		'Color', style.color( 'cold', 0 ) );
	...
	if ~any( isnan( trial.labeled.range ) ) % ranges
		rectangle( 'Position', [...
				sta.smp2msec( trial.labeled.range(1)-rzp, run.audiorate ), 0, ...
				sta.smp2msec( diff( trial.labeled.range )+1, run.audiorate ), diff( yl )/2], ...
			'EdgeColor', style.color( 'cold', 0 ), 'FaceColor', style.color( 'cold', +2 ) );
	end
	if ~any( isnan( trial.detected.range ) )
		rectangle( 'Position', [...
				sta.smp2msec( trial.detected.range(1)-rzp, run.audiorate ), yl(1), ...
				sta.smp2msec( diff( trial.detected.range )+1, run.audiorate ), diff( yl )/2], ...
			'EdgeColor', style.color( 'warm', 0 ), 'FaceColor', style.color( 'warm', +2 ) );
	end

	stem( sta.smp2msec( trial.labeled.bo-rzp, run.audiorate ), yl(2), ... % landmarks
		'Marker', 'o', 'MarkerSize', 2*style.width( +1 ), ...
		'MarkerEdgeColor', style.color( 'cold', -2 ), 'MarkerFaceColor', style.color( 'cold', +1 ), ...
		'Color', style.color( 'cold', 0 ) );
	stem( sta.smp2msec( trial.labeled.vo-rzp, run.audiorate ), yl(2), ...
		'Marker', 'o', 'MarkerSize', 2*style.width( +1 ), ...
		'MarkerEdgeColor', style.color( 'cold', -2 ), 'MarkerFaceColor', style.color( 'cold', +1 ), ...
		'Color', style.color( 'cold', 0 ) );
	stem( sta.smp2msec( trial.labeled.vr-rzp, run.audiorate ), yl(2), ...
		'Marker', 'o', 'MarkerSize', 2*style.width( +1 ), ...
		'MarkerEdgeColor', style.color( 'cold', -2 ), 'MarkerFaceColor', style.color( 'cold', +1 ), ...
		'Color', style.color( 'cold', 0 ) );
	stem( sta.smp2msec( trial.detected.bo-rzp, run.audiorate ), yl(1), ...
		'Marker', 'o', 'MarkerSize', 2*style.width( +1 ), ...
		'MarkerEdgeColor', style.color( 'warm', -2 ), 'MarkerFaceColor', style.color( 'warm', +1 ), ...
		'Color', style.color( 'warm', 0 ) );
	stem( sta.smp2msec( trial.detected.vo-rzp, run.audiorate ), yl(1), ...
		'Marker', 'o', 'MarkerSize', 2*style.width( +1 ), ...
		'MarkerEdgeColor', style.color( 'warm', -2 ), 'MarkerFaceColor', style.color( 'warm', +1 ), ...
		'Color', style.color( 'warm', 0 ) );
	stem( sta.smp2msec( trial.detected.vr-rzp, run.audiorate ), yl(1), ...
		'Marker', 'o', 'MarkerSize', 2*style.width( +1 ), ...
		'MarkerEdgeColor', style.color( 'warm', -2 ), 'MarkerFaceColor', style.color( 'warm', +1 ), ...
		'Color', style.color( 'warm', 0 ) );
	...
	plot( ... % landmarks
		...
		'MarkerEdgeColor', style.color( 'cold', -2 ), 'MarkerFaceColor', style.color( 'cold', +1 ) );
	plot( ...
		sta.smp2msec( [trial.detected.bo, trial.detected.vo, trial.detected.vr]-rzp, run.audiorate ), ...
		min( freqs ) * [1, 1, 1], ...
		'LineStyle', 'none', 'Marker', 'o', 'MarkerSize', 2*style.width( +1 ), ...
		'MarkerEdgeColor', style.color( 'warm', -2 ), 'MarkerFaceColor', style.color( 'warm', +1 ) );
