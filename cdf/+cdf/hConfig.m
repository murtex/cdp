...
% framework configuration
	...
	properties (Access = public)
		...
		lab_activity_det2 = [NaN, NaN]; % (relative) detail #2 (stop) [start, stop] (row numeric)
		...
		lab_landmarks_det2 = [NaN, NaN]; % (relative) detail #2 (voice onset) [start, stop] (row numeric)
		lab_landmarks_det3 = [NaN, NaN]; % (relative) detail #3 (voice voice release) [start, stop] (row numeric)
		...
		aud_activity_det2 = [NaN, NaN]; % (relative) detail #2 (stop) [start, stop] (row numeric)

		aud_landmarks_det1 = [NaN, NaN]; % (relative) landmarks detail #1 (burst onset) [start, stop] (row numeric)
		aud_landmarks_det2 = [NaN, NaN]; % (relative) detail #2 (voice onset) [start, stop] (row numeric)
		aud_landmarks_det3 = [NaN, NaN]; % (relative) detail #3 (voice release) [start, stop] (row numeric)
