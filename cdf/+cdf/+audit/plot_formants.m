...
% callback : button down event dispatcher [function, argument] (vector cell)
	...
	function plot_marks( flegend ) % formant onsets
		scatter( (resplab.f0(1) - trial.range(1)) * 1000, resplab.f0(2), ... % manual
			'ButtonDownFcn', callback, ...
			'LineWidth', 2, 'MarkerEdgeColor', style.color( 'warm', +2 ), 'MarkerFaceColor', 'none' );
		h1 = scatter( (resplab.f1(1) - trial.range(1)) * 1000, resplab.f1(2), ...
			'ButtonDownFcn', callback, ...
			'MarkerEdgeColor', style.color( 'warm', +1 ), 'MarkerFaceColor', style.color( 'warm', +2 ), ...
			'DisplayName', 'manual' );
		...
		scatter( (respdet.f0(1) - trial.range(1)) * 1000, respdet.f0(2), ... % detected
			'ButtonDownFcn', callback, ...
			'LineWidth', 2, 'MarkerEdgeColor', style.color( 'signal', +2 ), 'MarkerFaceColor', 'none' );
		h2 = scatter( (respdet.f1(1) - trial.range(1)) * 1000, respdet.f1(2), ...
			'ButtonDownFcn', callback, ...
