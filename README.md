...
- also each directory of this package comes up with a (more or less) descriptive **README file** outlining what is inside (actually you are now reading one of these)
...
- the package itself needs to be in the **MATLAB search path** in order to use its functionality (refer to [addpath](https://www.mathworks.com/help/matlab/ref/addpath.html "MATLAB documentation") on how to achieve this)
